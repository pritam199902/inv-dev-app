...
export default function AddVendor(props) {
  ...
  const handleAddNewVendor = () => {
    props.func.handleAddVendor(newVendorData);
    ...
    <>
      ...
      >
        <div className="row">
          ...
          <div className="col-4">
            <h4 style={titleText}>Add New Vendor</h4>
          </div>
          <div className="col-4">
            <h6 style={{ color: "#a6a6a6" }} className="float-right pt-2">
              ...
              <span
                style={{ color: "#fff" }}
                className="badge badge-pill badge-warning p-2"
              >
                {/* {props.data.itemCount} */}
                {props.data.vendorCount}
              </span>
            </h6>
          </div>
        </div>
          ...
          <div className="form-row p-1">
            ...
            <div className="col-6 ">
              ...
              >
                ...
                {catagory.map((data, i) => {
                  return <option value={data.value}>{data.cat}</option>;
                })}
              </select>
            </div>
          </div>
